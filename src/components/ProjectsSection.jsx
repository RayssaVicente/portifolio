...
const projects = [
    ...
    {
        id: 4,
        title: "Food Ecommecer",
        description: "Um site de ecommecer para uma lonchonete de bairro com opção de pagamento via cartão de credito, esse meu projeto consta com front-end com Next.js e backend em Node.js",
        image: "/assets/food-ecommecer.png",
        tags: ["HTML", "CSS", "JavaScript", "Node.js", "Next.js"],
        demoUrl: "https://food-ecommecer.vercel.app",
        githubUrl: "https://github.com/RayssaVicente/food-ecommecer.git",
    },
